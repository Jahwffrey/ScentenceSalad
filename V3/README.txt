...
IMPORTANT NOTE:
-If neither text files have and periods, question marks, or exclamation points it will not work.
...
-As long as there are two .txt files named "text1" and "text2", the porgram should run.
